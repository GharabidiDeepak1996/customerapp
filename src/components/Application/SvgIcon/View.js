...
export const SvgIcon = props => {
  ...
  if (type === IconNames.TrackBike) {
    return (
      <TrackBike style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.TrackTrain) {
    return (
      <TrackTrain style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.TrackShip) {
    return (
      <TrackShip style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.TrackDamri) {
    return (
      <TrackDamri style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Location) {
    return (
      <Location style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Copy) {
    return <Copy style={[style]} width={width} height={height} fill={color} />;
  } else if (type === IconNames.RotateRight) {
    return (
      <RotateRight style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.HandPoint) {
    return (
      <HandPoint style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Message) {
    return (
      <Message style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Close) {
    return <Close style={[style]} width={width} height={height} fill={color} />;
  } else if (type === IconNames.Exchange) {
    return (
      <Exchange style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Exchange1) {
    return (
      <Exchange1 style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Google) {
    return '';
  ...
  } else if (type === IconNames.StarGreen) {
    return (
      <StarGreen style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.StarGray) {
    return (
      <StarGray style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Star) {
    return <Star style={[style]} width={width} height={height} fill={color} />;
  ...
  } else if (type === IconNames.Food) {
    return <Food style={[style]} width={width} height={height} fill={color} />;
  } else if (type === IconNames.Grocery) {
    return (
      <Grocery style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.taxibike) {
    return (
      <Taxibike style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Courier) {
    return (
      <Courier style={[style]} width={width} height={height} fill={color} />
    );
  } else if (type === IconNames.Info) {
    return <Info style={[style]} width={width} height={height} fill={color} />;
  } else if (type === IconNames.FishNew) {
    return (
      <FishNew style={[style]} width={width} height={height} fill={color} />
    );
  } else {
    return (
      <Google style={[style]} width={width} height={height} fill={color} />
