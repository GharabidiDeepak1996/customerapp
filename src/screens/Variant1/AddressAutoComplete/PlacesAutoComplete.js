...
export const PlacesAutoComplete = props => {
  ...
  const isFromSend = props.route.params.isFromSend || false;
  const isFromRide = props.route.params.isFromRide || false;
  const isEdit = props.route.params.isEdit || false;
  const isFromServiceLocation =
    props.route.params.isFromServiceLocation || false;

  console.log('isNEw', isNew);
  console.log('isFromServiceLocation', isFromServiceLocation);
