const colors = {
  ...
  primaryGreenColor: '#2d2e7d',
  primaryDarkGreenColor: '#0090c7',

  //Active/Inactive tint color
  //activeColor: '#4E9F3D',
  activeColor: '#2d2e7d',
  inactiveColor: '#e3f7ff',
  ...
  //subHeadingSecondaryColor: '#1E5128',12A7E0
  subHeadingSecondaryColor: '#2d2e7d',
  subHeadingTertiaryColor: '#F3F5F8',
  subHeadingQuaternaryColor: '#1D68C5',

  //Button
  //buttonBackground: "#1E5128",
  buttonBackground: '#2d2e7d',
  buttonColor: '#D8E9A8',
  primaryShadowStart: '#6cc51d4d',
  primaryShadowFinal: '#6cc51d1a',

  //Switch
  //switchActiveBackground: '#1E5128',12A7E0
  switchActiveBackground: '#2d2e7d',
  ...
  //Pagination Color
  //paginationDotActiveColor: '#1E5128',12A7E0
  paginationDotActiveColor: '#2d2e7d',
